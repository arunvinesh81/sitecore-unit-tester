function revertMetaInfo() {
     if (window.operations.getmeta) {
          document.querySelector('#metaInfoTable').remove();
          window.operations.getmeta = false;
     }     
     return window.operations;
}

function applyMetaInfo() {
     window.operations = window.operations || {};
     if (window.operations.getmeta) {
          return revertMetaInfo();          
     }
     window.operations.getmeta = true;
     var x = document.getElementsByTagName("meta");
     var txt = "";
     var i;
     var body = document.querySelector('body');
     var table = document.createElement('table');
     table.id = 'metaInfoTable';
